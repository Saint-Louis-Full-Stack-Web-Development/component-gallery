<style>
    ...
    #search-input{width: 50%; font-size:3em; padding-left: 10px;}
</style>
...
<script>
    ...
    var infoWindowPlace = require('./infoWindowTemplate.js')()
        ...
        methods: {
            ...
            addPlaceChangeListener: function (){
                ...
                google.maps.event.addListener(component.autoComplete, 'place_changed', function (){
                    ...
                    //*change all following instances of `place` to `this.place` if this works */
                    this.place = place
                    ...
                    // component.setInfoWindowContents(fillInfoWindow(place, component, 'savePlace'))
